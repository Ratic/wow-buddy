...
use XRealm\UserBundle\Form\Type\UserType;
...
class SecurityController extends Controller
{
    ...
    public function registerAction(Request $request)
    {
		...
		if($form->isValid() && $form->isSubmitted())
		{
			...
			$role = $this->getRepository('XRealm\\UserBundle\\Entity\\Role')->findOneByRole('ROLE_USER');
			$user->addRole($role);
        ...
        return $this->render(
            'XRealmAppBundle:Pages:login.html.twig', array(
				'form'  => $form->createView(),
				'error' => $error,
